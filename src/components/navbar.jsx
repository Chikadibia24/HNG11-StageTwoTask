  ...
  return (
    <nav className="nav flex items-center justify-center w-[100%] bg-[#606060] h-[80px] pl-[30px] pr-[30px] sticky top-0">
      <div className="nav-sub-container w-[94%] flex items-center justify-between h-[80px]">
        ...
        <div className="discount-container flex items-center p-0 h-[80px] justify-center w-[301px] gap-[12px]">
          <div>
            <p className="text-white text-[14px]">Get 50% Off Selected Items</p>
          </div>

          <div className="vertical-line self-start m-0  border-l-[1px] border-l-[#ffffff] h-[70px]"></div>
        ...
        <div className="nigeria-container flex items-center justify-center w-[197px] h-[80px] gap-[40px]">
          ...
          <div className="flex items-center justify-center gap-[12px]">
            <img src={flagNigeria} alt="flagNigeria" />
